...
int BMPLoader::ImageLoad(char *filename, BMPImage *image) {
  FILE *file;
...
BMPImage *BMPLoader::LoadTexture(char* image_file, unsigned int texID) { 
  
  BMPImage *TextureImage = new BMPImage;
