...
int	TextureLoader::LoadTextureFromDisk(char *szFileName, glTexture *pglTexture)
{
	...
	{
		GetCurrentDirectory(MAX_PATH, (LPSTR)szFullPath);						// Get Our Working Directory
	...
	else
	{
		...
		if (strcmp(szExtension, "bmp") == 0)
		{
			pglTexture->TexType = txBmp;
		}
		else if ((strcmp(szExtension, "jpg") == 0) ||
				 (strcmp(szExtension, "jpeg") == 0) )
		{
			pglTexture->TexType = txJpg;
		}
		else if (strcmp(szExtension, "gif") == 0)
		{
			pglTexture->TexType = txGif;
		}
		else if (strcmp(szExtension, "ico") == 0)
		{
			pglTexture->TexType = txIco;
		}
		else if (strcmp(szExtension, "emf") == 0)
		{
			pglTexture->TexType = txEmf;
		}
		else if (strcmp(szExtension, "wmf") == 0)
		{
...
int	TextureLoader::LoadTextureFromRam(unsigned char *pData, int Length, glTexture *pglTexture, eglTexType TexType)
{
	...
	strcat(szTempFileName, "glTEMP$$.tmp");
