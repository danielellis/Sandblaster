...
bool MainMenuMode::LoadResources() {
    ...
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/background.tga", &mBackgroundTexture) == TRUE);
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/title.tga", &mTitleTexture) == TRUE);

    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/play.tga", &mButtons[BTN_PLAY].mTexture) == TRUE);
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/options.tga", &mButtons[BTN_OPTIONS].mTexture) == TRUE);
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/quit.tga", &mButtons[BTN_QUIT].mTexture) == TRUE);

    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/play_pressed.tga", &mButtons[BTN_PLAY].mPressedTexture) == TRUE);
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/options_pressed.tga", &mButtons[BTN_OPTIONS].mPressedTexture) == TRUE);
    assert(mTextureLoader.LoadTextureFromDisk("assets/textures/menu/quit_pressed.tga", &mButtons[BTN_QUIT].mPressedTexture) == TRUE);
